...
class OpenoptionController extends AController
{
    public $h1 = 'Варианты открывания';
    public $title = 'Варианты открывания';
    public $model_name = 'OpenOption';
    ...
    public function actionUpdate($id = 0)
    {
        $id = (int)$id;
        if (0 == $id) {
            $this->h1 = 'Создание варианта';
            $model = $this->getModel();
        } else {
            $this->h1 = 'Редактирование варианта';
