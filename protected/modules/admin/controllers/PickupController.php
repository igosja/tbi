...
class PickupController extends AController
{
    public $h1 = 'Точки самовывоза';
    public $title = 'Точки самовывоза';
    public $model_name = 'Pickup';
    ...
    public function actionUpdate($id = 0)
    {
        $id = (int)$id;
        if (0 == $id) {
            $this->h1 = 'Создание точки самовывоза';
            $model = $this->getModel();
        } else {
            $this->h1 = 'Редактирование точки самовывоза';
