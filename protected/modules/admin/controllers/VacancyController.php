...
class VacancyController extends AController
{
    public $h1 = 'Вакансии';
    public $title = 'Вакансии';
    public $model_name = 'Vacancy';
    ...
    public function actionUpdate($id = 0)
    {
        $id = (int)$id;
        if (0 == $id) {
            $this->h1 = 'Создание вакансии';
            $model = $this->getModel();
        } else {
            $this->h1 = 'Редактирование вакансии';
        ...
        if (0 != $id) {
            $this->breadcrumbs[$model->position] = array('view', 'id' => $model->id);
        }
